...
from metad2a.MetaD2A_nas_bench_201.nas_bench_201.config_utils import (
    dict2config,
)
from metad2a.MetaD2A_nas_bench_201.nas_bench_201.log_utils import (
    AverageMeter,
    convert_secs2time,
    time_string,
)
from metad2a.MetaD2A_nas_bench_201.nas_bench_201.models import (
    get_cell_based_tiny_net,
)
from metad2a.MetaD2A_nas_bench_201.nas_bench_201.nasbench_utils import (
    get_model_infos,
    obtain_accuracy,
)
from metad2a.MetaD2A_nas_bench_201.nas_bench_201.procedures import (
    get_optim_scheduler,
    prepare_seed,
)
...
def pure_evaluate(
    xloader, network, criterion=torch.nn.CrossEntropyLoss()
):
